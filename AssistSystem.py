...
class AssistDashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.save_folder = (
            r"C:\Users\Gound\Desktop\graph values"  # CHANGE if needed(paste the required path to save the .csv file)
        )
    ...
    def init_ui(self):
        ...
        self.eda_curve = self.eda_plot.plot(pen=pg.mkPen("#38bdf8", width=2))
    ...
    async def _stop_and_save(self):
        ...
        try:
            with open(full_path, mode="w", newline="") as file:
                ...
                writer.writerow(["Time", "ECG", "EDA", "Acc_X", "Acc_Y", "Acc_Z"])
